...
public class ECHOESRESTAPIEchoesaddcClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "ECHOESRESTAPIEchoesaddcClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:ECHOESRESTAPIEchoesaddcClient = {
        ...
        return ECHOESRESTAPIEchoesaddcClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = ECHOESRESTAPIEchoesaddcClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `ECHOESRESTAPIEchoesaddcClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> ECHOESRESTAPIEchoesaddcClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         ECHOESRESTAPIEchoesaddcClient.registerClient(withConfiguration: configuration, forKey: "USWest2ECHOESRESTAPIEchoesaddcClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = ECHOESRESTAPIEchoesaddcClient.client(forKey: "USWest2ECHOESRESTAPIEchoesaddcClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(ECHOESRESTAPIEchoesaddcClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> ECHOESRESTAPIEchoesaddcClient {
		objc_sync_enter(self)
		if let client: ECHOESRESTAPIEchoesaddcClient = _serviceClients.object(forKey: key) as? ECHOESRESTAPIEchoesaddcClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			ECHOESRESTAPIEchoesaddcClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! ECHOESRESTAPIEchoesaddcClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://sbtq4uyone.execute-api.us-east-1.amazonaws.com/Prod"
